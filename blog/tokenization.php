...
<p>So in &ldquo;this test&rdquo;, we wish to check tokenization; among other things. So..., we ask a question? A make a statement statement! (and maybe a note). I’ll check some other stuff, like we may have&nbsp;&nbsp;&nbsp;exagerated&nbps;&nbsp;&nbsp;spacing! Or strange quotes, like «en français» or &#x84;auf Deutsch&#x93;.</p>
...
<p>However, this creates it’s own issues: firstly now each space is its own token and compound punctuations doesn’t work, &ldquo;like in quotes<b>.&rdquo;</r> Even worse, contractions like &ldquo;doesn’t&rdquo; get split into three tokens. Not great... I present my solution:</p>
